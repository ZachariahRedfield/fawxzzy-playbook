...
Then run the guided onboarding workflow in the official demo repository artifact (`playbook-demo`):
...
## Current product command surface

Playbook’s current product-facing command surface is:
...
- `plan`
- `apply`
- `playbook-demo` (official demo repository artifact, discoverable via `playbook demo`)
