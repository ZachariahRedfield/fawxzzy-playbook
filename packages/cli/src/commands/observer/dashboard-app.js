...
const artifactKinds = ['cycle-state','cycle-history','policy-evaluation','policy-apply-result','pr-review','session','system-map','promotion-receipt-story','promotion-receipt-pattern','pattern-candidates','patterns'];
