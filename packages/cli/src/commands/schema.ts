...
const printUsage = (): void => {
  console.error('Usage: playbook schema [rules|explain|index|graph|verify|plan|context|ai-context|ai-contract|doctor|analyze-pr|query|docs|contracts|ignore|learn|memory] [--json]');
};
