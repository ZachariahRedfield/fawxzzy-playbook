...
export { runBootstrapProof } from './adoption/bootstrapProof.js';
export type { BootstrapProofStage, BootstrapProofFailureCategory, BootstrapProofCheck, BootstrapProofResult } from './adoption/bootstrapProof.js';
