...
- `playbook story candidates --json` derives inspectable advisory candidates into `.playbook/story-candidates.json` without mutating the canonical backlog.
- `playbook story promote <candidate-id> --json` explicitly promotes one advisory candidate into `.playbook/stories.json`.
