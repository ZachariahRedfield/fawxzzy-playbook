...
Manage the canonical repo-local story backlog artifact at `.playbook/stories.json` while keeping advisory candidate derivation in non-canonical `.playbook/story-candidates.json`.
